...
public class TelaValores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblDiv.setFont(new java.awt.Font("Liberation Sans", 0, 18)); // NOI18N
        lblDiv.setForeground(new java.awt.Color(0, 0, 204));
        lblDiv.setText("0");

        lblResto.setFont(new java.awt.Font("Liberation Sans", 0, 18)); // NOI18N
        lblResto.setForeground(new java.awt.Color(0, 204, 0));
        lblResto.setText("0");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtDen, javax.swing.GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)
                            .addComponent(txtNum))
    ...
    private void btnDividirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDividirActionPerformed
        ...
        float numerador = Integer.parseInt(txtNum.getText());
        float denominador = Integer.parseInt(txtDen.getText());
        Float resultado = numerador / denominador;
        Float resto = numerador % denominador;
        lblDiv.setText(resultado.toString());
        lblResto.setText(resto.toString());        
